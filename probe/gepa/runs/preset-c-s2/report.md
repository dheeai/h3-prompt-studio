# GEPA run — 2026-09-19T16:24:04.527Z
...
## Seed (preset A)
train mean: 0.762 · held-out mean: 0.747
...
## Cost
GPU wall-clock (task-model authoring only): 12.6 min (754364 ms across 19 evaluate() calls, 19 of which authored)
...
Winner prompts saved: 19/19 to probe/gepa/runs/preset-c-s2/winner-prompts/

## Concurrency
Bound: 4 (must track the llama.cpp server's --parallel slot count)
Pool wall-clock: 3.6 min · summed call time (author + judge): 13.0 min · achieved parallelism: 3.64x
