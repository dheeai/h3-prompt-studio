# GEPA run — 2026-09-19T16:28:01.161Z
...
## Seed (preset A)
train mean: 0.781 · held-out mean: 0.758
...
## Cost
GPU wall-clock (task-model authoring only): 13.7 min (819506 ms across 19 evaluate() calls, 19 of which authored)
...
Winner prompts saved: 19/19 to probe/gepa/runs/preset-c-s3/winner-prompts/

## Concurrency
Bound: 4 (must track the llama.cpp server's --parallel slot count)
Pool wall-clock: 3.9 min · summed call time (author + judge): 14.1 min · achieved parallelism: 3.57x
