# GEPA run — 2026-09-19T16:18:55.069Z
...
## Seed (preset A)
train mean: 0.797 · held-out mean: 0.748
...
## Cost
GPU wall-clock (task-model authoring only): 15.1 min (905615 ms across 19 evaluate() calls, 19 of which authored)
...
Winner prompts saved: 19/19 to probe/gepa/runs/preset-c-withrules/winner-prompts/

## Concurrency
Bound: 4 (must track the llama.cpp server's --parallel slot count)
Pool wall-clock: 4.2 min · summed call time (author + judge): 15.5 min · achieved parallelism: 3.70x
