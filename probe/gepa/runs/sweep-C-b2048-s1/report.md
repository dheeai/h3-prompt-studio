# GEPA run — 2026-09-19T16:48:35.936Z
...
## Seed (preset A)
train mean: 0.781 · held-out mean: 0.745
...
## Cost
GPU wall-clock (task-model authoring only): 20.6 min (1235231 ms across 19 evaluate() calls, 19 of which authored)
...
Winner prompts saved: 19/19 to probe/gepa/runs/sweep-C-b2048-s1/winner-prompts/

## Concurrency
Bound: 4 (must track the llama.cpp server's --parallel slot count)
Pool wall-clock: 5.8 min · summed call time (author + judge): 21.0 min · achieved parallelism: 3.61x
