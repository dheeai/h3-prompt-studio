# GEPA run — 2026-09-19T16:53:51.543Z
...
## Seed (preset A)
train mean: 0.779 · held-out mean: 0.757
...
## Cost
GPU wall-clock (task-model authoring only): 19.0 min (1138999 ms across 19 evaluate() calls, 19 of which authored)
...
Winner prompts saved: 19/19 to probe/gepa/runs/sweep-C-b2048-s2/winner-prompts/

## Concurrency
Bound: 4 (must track the llama.cpp server's --parallel slot count)
Pool wall-clock: 5.3 min · summed call time (author + judge): 19.4 min · achieved parallelism: 3.69x
