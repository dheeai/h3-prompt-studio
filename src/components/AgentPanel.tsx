  ...
  useEffect(() => {
    ...
    const unsubscribe = agent.subscribe((event: AgentEvent) => {
      ...
      if (event.type === 'tool_execution_end') {
        ...
        if (details?.requiresConfirmation === 'render_current' || details?.requiresConfirmation === 'render_extender_plan') setPending(details.requiresConfirmation)
      }
