 ...
 * toggle instead). */
export const EXPLICIT_LORA_RE = /style gamma|style delta|style beta|style epsilon/i
...
export interface ChainBuildOpts {
   ...
   * customized renders exactly as before this existed (still style alpha @ 0.5
